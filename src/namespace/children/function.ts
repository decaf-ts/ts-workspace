...
/**
 * @function something
 * @summary Generic function that logs arguments and returns the context
 * @description This function is a generic method that extends the Class type. It logs all provided arguments
 * to the console and returns the context (this) of the function.
 *
 * @template T - Type extending {@link Class}
 * @template V - Type of the arguments
 * @this {T}
 * @param {...V} args - Variable number of arguments of type V
 * @returns {Type<T>} Returns the context (this) of the function
 *
 * @example
